    ...
    <div class="main-container">
        ...
        <div class="form-container">
            <div class="form">
                ...
                <form action="{{ route('management.legends.update', $legend->id) }}" method="POST"
            ...
            <div class="form">
                ...
                <form action="{{ route('management.security.create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="group">
                ...
                <div class="data">
                    @foreach ($securities as $security)
                        <div class="card">
                            ...
                            <div class="action">
                                <a href="{{ route('management.security.edit', $security->id) }}" class="btn warning"><i
                                        class="fa-solid fa-pen-to-square"></i></a>
                                <a href="" class="btn danger"><i class="fa-solid fa-delete-left"></i></a>
                            </div>
                        </div>
